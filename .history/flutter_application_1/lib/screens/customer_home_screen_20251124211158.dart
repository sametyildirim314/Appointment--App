...
class _CustomerHomeScreenState extends State<CustomerHomeScreen> {
  ...
  Future<void> _loadAppointments() async {
    ...
    try {
      ...
      final appointments =
          await _appointmentService.getCustomerAppointments(customerId);
                    ...
                    child: RefreshIndicator(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 24),
                          _buildSectionTitle('Randevularım', _appointments.length),
  ...
  Widget _buildEmptyState() {
    return _buildGlassCard(
      child: Padding(
        ...
        child: Column(
          children: [
            Icon(Icons.event_available, size: 64, color: Colors.white.withOpacity(0.5)),
            const SizedBox(height: 20),
            const Text(
      ...
      child: Column(
        ...
        children: [
          ...
          if (appointment.serviceName != null) ...[
            const SizedBox(height: 12),
            _buildInfoRow(Icons.content_cut, appointment.serviceName!,
                isBold: true),
          ],
          ...
          if (appointment.servicePrice != null || appointment.serviceDuration != null) ...[
            const SizedBox(height: 16),
            Wrap(
              spacing: 12,
              runSpacing: 8,
