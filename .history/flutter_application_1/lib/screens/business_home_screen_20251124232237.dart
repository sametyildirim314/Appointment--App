    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            Color(0xFF232B3E), // çok koyu mavi-gri (arka plan derinliği)
            Color(0xFF3B486B), // ana koyu mavi-gri
            Color(0xFF6A7BA2), // modern, yumuşak mavi-gri
            Color(
              0xFFE9ECF5,
            ), // çok açık, göz yormayan mavi-gri (kullanıcı dostu)
          ],
