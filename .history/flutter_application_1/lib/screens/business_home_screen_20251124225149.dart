...
class _BusinessHomeScreenState extends State<BusinessHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF242C3D),
      body: Stack(
        children: [
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            Color(0xFF2F3A54), // orta koyulukta mavi-gri
            Color(0xFF242C3D), // ana arka plan
            Color(0xFF3E4C6B), // hafif vurgu
          ],
          stops: [0.0, 0.5, 1.0],
        ),
      ),
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: [
                  const Color(0xFF5166A6).withOpacity(0.35),
                  Colors.transparent,
                ],
              ),
            ),
        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: [
                  const Color(0xFF4F5FA0).withOpacity(0.25),
                  Colors.transparent,
                ],
              ),
            ),
