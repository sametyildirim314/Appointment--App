...
/// Müşteri kullanıcılarının randevu özetlerini görüp yeni işlem başlatabildiği
/// ana ekran; metrik kartları ve liste bileşenleri burada toplanır.
...
class _CustomerHomeScreenState extends State<CustomerHomeScreen> {
  ...
  /// Randevuları gezip özet kartlarında gösterilen istatistikleri çıkarır.
  ...
  /// Kullanıcıyı yeni randevu oluşturmaya yönlendiren ana aksiyon butonu.
  ...
  /// Gelir/adet gibi hızlı metrik kartlarını bir araya getirir.
  ...
  /// Tek bir özet metrik kartının görsel yapısı.
  ...
  /// Randevuya dair tüm detay ve aksiyonları gösteren kart.
  ...
  /// Kart içindeki tekrar eden ikon + metin satırları için yardımcı builder.
  ...
  /// Ücret / süre gibi mikro bilgileri “chip” halinde gösterir.
  ...
  /// Uygulamanın pek çok yerinde kullanılan glassmorphism kart şablonu.
