...
/// İşletmelerin tüm yönetim araçlarını (istatistik, hizmet/ekip/randevu) tek
/// ekranda toplayan ana kontrol paneli.
...
class _BusinessHomeScreenState extends State<BusinessHomeScreen> {
  // Servisler + dashboard bileşenlerinin ihtiyaç duyduğu ortak veriler.
  ...
  /// Randevular üzerinden dashboard kartlarını besleyecek sayısal özetleri
  /// hesaplar (gelir, adet, durum dağılımı vb.).
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: [
                  const Color(0xFF6C7BAF).withOpacity(0.28),
                  Colors.transparent,
                ],
              ),
            ),
        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: [
                  const Color(0xFF8AA0DA).withOpacity(0.2),
                  Colors.transparent,
                ],
              ),
            ),
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _buildFeatureChip(Icons.calendar_today, 'Randevu Yönetimi'),
              _buildFeatureChip(Icons.attach_money, 'Gelir Takibi'),
              _buildFeatureChip(Icons.people, 'Ekip Yönetimi'),
              _buildFeatureChip(Icons.settings, 'Hizmet Yönetimi'),
            ],
          ),
        ],
      ),
  ...
  /// Glassmorphism görünümünü tekrar kullanabilmek için ortak kart şablonu.
  ...
  /// Hizmet CRUD akışını yöneten kart ve liste yapısı.
  ...
  /// Tek bir hizmet kaydını kart şeklinde gösterir; durum ve aksiyonları içerir.
  ...
  /// Çalışan ekleme/düzenleme/aktif-pasif işlemlerini sunan kart.
  ...
  /// Her çalışan satırı için avatar + iletişim + aksiyon butonları üretir.
